...
class GrasslandForm(forms.Form):
    ...
    farmer_address_line_1 = forms.CharField(
        max_length=30,
        required=True,
        widget=forms.TextInput(attrs={"class": "formclass"}),
    )
    farmer_address_line_2 = forms.CharField(
        max_length=30, widget=forms.TextInput(attrs={"class": "formclass"})
    )
    farmer_address_line_3 = forms.CharField(
        max_length=30, widget=forms.TextInput(attrs={"class": "formclass"})
    )
    ...
    county = forms.CharField(
        ...
        widget=forms.Select(
            choices=counties, attrs={"class": "formclass", "style": "width:276px"}
        ),
        max_length=1,
    )
...
class Grassland4(forms.Form):
    ...
    number_maize_gluten = forms.IntegerField(
        widget=forms.TextInput(attrs={"class": "formclass"}), initial=0
    )
    number_copra = forms.IntegerField(
        widget=forms.TextInput(attrs={"class": "formclass"}), initial=0
    )
    number_cotton_seed = forms.IntegerField(
        widget=forms.TextInput(attrs={"class": "formclass"}), initial=0
    )
    number_palm_kernel = forms.IntegerField(
        widget=forms.TextInput(attrs={"class": "formclass"}), initial=0
    )
    number_rapeseed = forms.IntegerField(
        widget=forms.TextInput(attrs={"class": "formclass"}), initial=0
    )
    number_soya_bean = forms.IntegerField(
        widget=forms.TextInput(attrs={"class": "formclass"}), initial=0
    )
    number_sunflower = forms.IntegerField(
        widget=forms.TextInput(attrs={"class": "formclass"}), initial=0
    )
    number_peas = forms.IntegerField(
        widget=forms.TextInput(attrs={"class": "formclass"}), initial=0
    )
    number_beans = forms.IntegerField(
        widget=forms.TextInput(attrs={"class": "formclass"}), initial=0
    )
    number_soya_hulls = forms.IntegerField(
        widget=forms.TextInput(attrs={"class": "formclass"}), initial=0
    )
    number_distillers_grain = forms.IntegerField(
        widget=forms.TextInput(attrs={"class": "formclass"}), initial=0
    )
    number_lucerne = forms.IntegerField(
        widget=forms.TextInput(attrs={"class": "formclass"}), initial=0
    )
...
class Grassland5(forms.Form):
    ...
    number_dairy_cows = forms.IntegerField(
        widget=forms.TextInput(attrs={"class": "formclass"}), initial=0
    )
    number_suckler_cows = forms.IntegerField(
        widget=forms.TextInput(attrs={"class": "formclass"}), initial=0
    )
    number_cattle1 = forms.IntegerField(
        widget=forms.TextInput(attrs={"class": "formclass"}), initial=0
    )
    number_cattle2 = forms.IntegerField(
        widget=forms.TextInput(attrs={"class": "formclass"}), initial=0
    )
    number_cattle3 = forms.IntegerField(
        widget=forms.TextInput(attrs={"class": "formclass"}), initial=0
    )
    number_mountain_ewe = forms.IntegerField(
        widget=forms.TextInput(attrs={"class": "formclass"}), initial=0
    )
    number_lowland_ewe = forms.IntegerField(
        widget=forms.TextInput(attrs={"class": "formclass"}), initial=0
    )
    number_mountain_hogget = forms.IntegerField(
        widget=forms.TextInput(attrs={"class": "formclass"}), initial=0
    )
    number_lowland_hogget = forms.IntegerField(
        widget=forms.TextInput(attrs={"class": "formclass"}), initial=0
    )
    number_goats = forms.IntegerField(
        widget=forms.TextInput(attrs={"class": "formclass"}), initial=0
    )
    number_horse1 = forms.IntegerField(
        widget=forms.TextInput(attrs={"class": "formclass"}), initial=0
    )
    number_horse2 = forms.IntegerField(
        widget=forms.TextInput(attrs={"class": "formclass"}), initial=0
    )
    farmer_name = forms.CharField(
